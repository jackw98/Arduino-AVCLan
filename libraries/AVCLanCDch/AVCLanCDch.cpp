...
const AvcInMessageTable  mtMain[] PROGMEM = {
	{ACT_REGISTER,       0x03, {0x11, 0x01, 0x46}},			// TEST	
	{ACT_PLAY_REQ1,      0x04, {0x00, 0x25, 0x43, 0x80}},
	{ACT_PLAY_IT,        0x04, {0x11, 0x01, 0x45, 0x43 }},
	...
	{ACT_LAN_CHECK, 	 0x05, {0x00, 0x11, 0x01, 0x20, 0x02}},
...
const AvcInMaskedMessageTable  mtMaskedMain[] PROGMEM = {
	...
	{ACT_LAN_CHECK,    0x05, {0x00, 0x11, 0x01, 0x20, 0}, _BV(4)},
	{ACT_PLAY_REQ2,    0x06, {0x00, 0x11, 0x43, 0x42, 0x41, 0x00}, _BV(4)},
	{ACT_STOP_REQ1,     0x05, {0x00, 0x12, 0x43, 0x43, 0}, _BV(4)},
	{ACT_STOP_REQ2,     0x06, {0x00, 0x11, 0x43, 0x43, 0x41, 0x00}, _BV(4)},
};
...
//TEST
const AvcInMessageTable  mtSearchHead[] PROGMEM = {
	{ACT_REGISTER,  0x03, {0x11, 0x01, 0x00}},           // AVC LAN register
	{ACT_REGISTER,  0x03, {0x11, 0x01, 0x01}},
	{ACT_REGISTER,  0x03, {0x11, 0x01, 0x46}},
	{ACT_REGISTER,  0x04, {0x11, 0x01, 0x45, 0x60}}
};
const byte mtSearchHeadSize = sizeof(mtSearchHead) / sizeof(AvcInMessageTable);

extern const AvcOutMessage CmdReset         PROGMEM =  {AVC_MSG_BROADCAST,  0x05, {0x00, 0x00, 0x00, 0x00, 0x00}}; // reset AVCLan. This causes HU to send ACT_REGISTER
extern const AvcOutMessage CmdRegister      PROGMEM =  {AVC_MSG_DIRECT,     0x05, {0x00, 0x01, 0x11, 0x10, 0x43}}; // register CD-changer
...
const AvcOutMessage CmdPlayOk1       PROGMEM =  {AVC_MSG_DIRECT,     0x05, {0x00, 0x43, 0x11, 0x50, 0x01}}; // Play begin message 1
const AvcOutMessage CmdPlayOk2       PROGMEM =  {AVC_MSG_DIRECT,     0x05, {0x00, 0x43, 0x11, 0x52, 0x01}}; // Play begin message 2
...
const AvcOutMessage CmdStopOk1       PROGMEM =  {AVC_MSG_DIRECT,     0x05, {0x00, 0x43, 0x11, 0x53, 0x01}}; // Stop ok message 1
...
const AvcOutMessage CmdLanCheckOk    PROGMEM =  {AVC_MSG_DIRECT,     0x06, {0x00, 0x01, 0x11, 0x30, 0, 0x00}}; // Check, device ok
